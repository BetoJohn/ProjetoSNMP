...
import br.com.snmp.job.JobGetSnmp;
...
@SessionScoped
public class SnmpBean implements Serializable{
    ...
    public void breakGetSnmp() {
        try {
            if (scheduler != null) {
                ...
                Logger.getLogger(DeviceBean.class.getName()).log(Level.INFO, "breakGetSnmp()", "");
                scheduler = null;
            ...
            Logger.getLogger(DeviceBean.class.getName()).log(Level.WARNING, null, ex);
        }
    }
