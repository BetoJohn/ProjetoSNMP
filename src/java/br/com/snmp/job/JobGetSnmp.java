 ...
 */
package br.com.snmp.job;

import br.com.snmp.BO.SnmpBO;
import br.com.snmp.bean.DeviceBean;
...
public class JobGetSnmp implements Job {
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        Logger.getLogger(DeviceBean.class.getName()).log(Level.INFO, "Servico executado conforme agendamento " + new Date(), "");
        try {
